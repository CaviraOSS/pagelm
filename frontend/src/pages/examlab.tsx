      ...
      <div className="grid gap-6">
        {exams.map((ex) => (
          <div
            key={ex.id}
            onClick={() => start(ex.id)}
            className="group rounded-2xl bg-zinc-950 border border-zinc-800 p-5 cursor-pointer hover:border-sky-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-sky-500/10"
          >
